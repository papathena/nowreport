...
class TopPhotoArticlesHelper {
    /* Photo Top Articles */
    /* B: Daily Top Photo Articles */
    public static function webTopPhotoArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	 ...
	 public static function androidTopPhotoArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
	...
	public static function iosTopPhotoArticles(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:date,ga:day,ga:dayOfWeekName,ga:week,ga:month,ga:year,ga:screenName'];
            $filters = 'all';
	...
	/* E: Daily Top Photo Articles */
	
	/* B: Monthly Top Photo Articles */
	public static function webTopPhotoArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function androidTopPhotoArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function iosTopPhotoArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:month,ga:year,ga:screenName'];
            $filters = 'all';
