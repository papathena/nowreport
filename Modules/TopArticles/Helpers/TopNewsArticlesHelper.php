...
class TopNewsArticlesHelper {
	/* News Top Articles */
    /* B: Daily Top News Articles */
    public static function webTopNewsArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	 ...
	 public static function androidTopNewsArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
	...
	public static function iosTopNewsArticles(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:date,ga:day,ga:dayOfWeekName,ga:week,ga:month,ga:year,ga:screenName'];
            $filters = 'all';
	...
	/* E: Daily Top News Articles */
	
	/* B: Monthly Top News Articles */
	public static function webTopNewsArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function androidTopNewsArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function iosTopNewsArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:month,ga:year,ga:screenName'];
            $filters = 'all';
