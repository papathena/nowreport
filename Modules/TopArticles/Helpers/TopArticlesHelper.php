...
class TopArticlesHelper {
	/* All Top Articles */
    /* B: Daily Top Articles */
    public static function webTopArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	 ...
	 public static function androidTopArticles(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
	...
	public static function iosTopArticles(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:date,ga:day,ga:dayOfWeekName,ga:week,ga:month,ga:year,ga:screenName'];
            $filters = 'all';
	...
	/* E: Daily Top Articles */
	
	/* B: Monthly Top Articles */
	public static function webTopArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function androidTopArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters=NULL)
    {
        if (is_null($filters)) {
	...
	public static function iosTopArticlesMonthly(Period $period, String $devices, String $channels=NULL, String $filters)
    {
        if (is_null($filters)) {
            $others = ['dimensions' => 'ga:month,ga:year,ga:screenName'];
            $filters = 'all';
