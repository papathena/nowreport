...
return [
	'socnet_name' => [
		'facebook' => ['title' => 'Facebook', 'filter' => 'facebook'],
		'twitter' => ['title' => 'Twitter', 'filter' => 'twitter|^t.co$'],
		'googleplus' => ['title' => 'Google Plus', 'filter' => 'plus.url.google.com'],
		'instagram' => ['title' => 'Instagram', 'filter' => 'instagram|igstories'],
		'whatsapp' => ['title' => 'Whatsapp', 'filter' => 'whatsapp'],
		'line' => ['title' => 'Line', 'filter' => '^line'],
		'telegram' => ['title' => 'Telegram', 'filter' => 'telegram']
	],
