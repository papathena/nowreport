...
class MonthlyTopPushArticlesController extends Controller
{
    ...
    protected function monthlyStore(
        ...
        String $title)
    {
        $gatoparticles = new MonthlyTopPushArticles();
    ...
    protected function MonthlyUpdate(
        ...
        String $title)
    {
        $gatoparticles = MonthlyTopPushArticles::where([
            'monthYear' => $month,
            'year' => $year,
            'devices' => $devices,
            'channels' => $channels,
    ...
    {
        $datas = MonthlyTopPushArticles::where([
            'monthYear' => $month,
            'devices' => $devices,
            'channels' => $channels,
            'pagetitle' => $title,
    ...
    public function monthlyGetData(Period $period, String $platform, String $devices, String $channels=NULL, String $filters=NULL)
    {
        ...
        switch ($platform) {
            case 'android' : $data = $getQuery->androidTopPushArticlesMonthly($period, $devices, $channels, $filters);
                break;
            case 'ios' : $data = $getQuery->iosTopPushArticlesMonthly($period, $devices, $channels, $filters);
                break;
            default : $data = $getQuery->webTopPushArticlesMonthly($period, $devices, $channels, $filters);
        }
        return $data;
    }
    /* E: Get Monthly Data*/
