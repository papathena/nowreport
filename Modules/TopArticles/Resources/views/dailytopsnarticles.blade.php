...
@section('headers')
	...
	<style> 
	#tabs, #tabs-snArticles
	{
			padding: 0;
	}

	#tabs ul, #tabs-snArticles ul
	{
		margin: 0;
		padding: 5px 10px;
	}

	#tabs ul li, #tabs-snArticles ul li
	{
...
@section('content')
	<div class="title">
		...
		<h2 class="title__main">
			Top Article (Social Network)
		</h2>
		<div class="title__cap">
			Pada laman ini akan menampilkan list top 10 artikel yang berasal dari social media tertentu. Silakan pilih kanal yang Anda inginkan, kemudian pilih sosial media yang Anda inginkan, dan pilih tanggal tertentu jika Anda ingin memantau traffic sebelumnya. 
		</div>
	</div>
		...
		<div class="white-space">
			<div class="section__box">
				...
				<h3 class="title__section">
					Daily Top 10 Article <small>(Social Network)</small>
				</h3>
