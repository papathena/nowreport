...
<style>
	.filter__menu, #tabs-imArticles
	{
			padding: 0;
	}

	.filter__menu ul, #tabs-imArticles ul
	{
		margin: 0;
		padding: 5px 10px;
	}

	.filter__menu ul li, #tabs-imArticles ul li
	{
...
<div class="section">
	...
	<!-- B: Inbound Marketing Top 10 Articles Table  -->
	<div class="white-space">
		<div class="section__box">
			...
			<h3 class="title__section">
				Monthly Top 10 Article <small>(Inbound Marketing)</small>
			</h3>
				...
				<table class="table-default" data-table="sorter">
					...
					<tbody>
						@foreach($imTopArticles as $imArticles)
							<tr>
								<td>{{ $imArticles['monthName'] }}</td>
								<td>{{ $imArticles['year'] }}</td>
	...
	<!-- E: Inbound Marketing Top 10 Articles Table -->
