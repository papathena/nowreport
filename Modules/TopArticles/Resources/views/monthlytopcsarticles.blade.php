...
<style>
	.filter__menu, #tabs-csArticles
	{
			padding: 0;
	}

	.filter__menu ul, #tabs-csArticles ul
	{
		margin: 0;
		padding: 5px 10px;
	}

	.filter__menu ul li, #tabs-csArticles ul li
	{
...
<div class="title">
	...
	<h2 class="title__main">
		Monthly Top Articles (Channel Source)
	</h2>
	<div class="title__cap">
		Pada laman ini akan menampilkan list top 10 artikel yang berasal dari channel source tertentu. Silakan pilih kanal yang Anda inginkan, kemudian pilih channel source yang Anda inginkan, dan pilih bulan tertentu jika Anda ingin memantau traffic sebelumnya.
	</div>
</div>
	...
	<div class="white-space">
		<div class="section__box">
			...
			<h3 class="title__section">
				Monthly Top 10 Article <small>(Channel Source)</small>
			</h3>
				...
				<table class="table-default" data-table="sorter">
					...
					<tbody>
						@foreach($csTopArticles as $csArticles)
							<tr>
								<td>{{ $csArticles['monthName'] }}</td>
								<td>{{ $csArticles['year'] }}</td>
