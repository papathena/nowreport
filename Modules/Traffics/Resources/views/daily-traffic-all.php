				...
				<div class="filter">
					...
					<div class="filter__menu">
						<div class="filter__menu-item">
							<a href="daily-traffic-all.php" class="active">
								All Platform
							</a>
						</div>
						<div class="filter__menu-item">
							<a href="daily-traffic-all-web.php" class="">
								All Web (Desktop + Mobile)
							</a>
						</div>
						<div class="filter__menu-item">
							<a href="daily-traffic-desktop.php">
								Desktop
							</a>
						</div>
						<div class="filter__menu-item">
							<a href="daily-traffic-m.php">
								Mobile
							</a>
						</div>
						<div class="filter__menu-item">
							<a href="daily-traffic-android.php">
								Android
							</a>
						</div>
						<div class="filter__menu-item">
							<a href="daily-traffic-ios.php">
								IOS
							</a>
						</div>
					</div>
